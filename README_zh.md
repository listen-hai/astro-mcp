...
| 容许度（orb） | 合/冲 8°，刑/拱 7°，六合 6°，次相位 2–3° | ——（暂不作为输入参数开放） | 现代惯例：容许度按**相位类型**定，而非按各星体自身光体（古典 moiety）定。目前尚未开放为参数，见「已知局限」。 |
...
- **小天体**（凯龙 + 四颗小行星，用 `GravitySimulator` 配合 JPL 状态向量种子积分）：≤ 1.5 角分，误差主要由种子与模型精度主导，而非积分步长。凯龙用 4 天步长；四颗内圈小行星（轨道更快更近）需要 0.25 天步长才能守住同样的精度——4 天步长下实测偏差最大达 2°，等于落错一整个星座。

| 天体 | 1900 | 1950 | 1990 | 2026 | 2050 | 2100 | 步长 |
|---|---|---|---|---|---|---|---|
| 凯龙 | 1.07′ | 0.67′ | 0.32′ | 0.18′ | 0.01′ | 0.13′ | 4 天 |
| 谷神 | 0.47′ | 0.32′ | 0.26′ | 0.17′ | 0.43′ | 0.21′ | 0.25 天 |
| 智神 | 0.57′ | 0.33′ | 0.39′ | 0.37′ | 0.17′ | 0.03′ | 0.25 天 |
| 婚神 | 0.04′ | 0.19′ | 0.28′ | 0.11′ | 0.22′ | 0.75′ | 0.25 天 |
| 灶神 | 0.17′ | 0.32′ | 0.20′ | 0.16′ | 0.11′ | 0.20′ | 0.25 天 |
